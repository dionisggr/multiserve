const instructions = {
  paragraph: `
    ...
    The response should be a single concise paragraph.
  ...
  structured: `
    ...
    ***Important Constraint*: Ensure the final result is optimized for GPT-3.5 and GPT-4, also known as ChatGPT, with a primary focus on tailoring the prompt according to the desired output.**

    Respond only with the enhanced prompt and no explanations.
